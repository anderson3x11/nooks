...
| Carte | Leaflet + tuiles OpenStreetMap | Marqueurs dessinés en SVG, un symbole et une couleur par catégorie |
...
- **Tuiles OpenStreetMap**, dont la politique d'usage ne couvre pas un vrai trafic. Un fournisseur de tuiles serait nécessaire en production.
